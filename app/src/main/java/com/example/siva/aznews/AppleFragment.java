...
public class AppleFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<techList>>, SwipeRefreshLayout.OnRefreshListener {
    public static final String LOG_TAG = AppleFragment.class.getName();
    /** URL for earthquake data from the USGS dataset */
    private static final String USGS_REQUEST_URL =
            "https://newsapi.org/v2/everything?q=apple&from=2018-08-14&to=2018-08-14&sortBy=popularity&apiKey=47ada2986be0434699996aaf4902169b";
    ...
    @Override
    public void onLoadFinished(Loader<List<techList>> loader, List<techList> apple) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ListView businessListView = (ListView) rootView.findViewById(R.id.list_apple);
        ...
        businessListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                intent.putExtra("author", currentEarthquake.getmAuthor());//you can name the keys whatever you like
        ...
        AppleFragment.AppleAsyncTask task = new AppleFragment.AppleAsyncTask();
...
// Create and start a new Thread
    ...
    private class AppleAsyncTask extends AsyncTask<String, Void, List<techList>> {
        @Override
